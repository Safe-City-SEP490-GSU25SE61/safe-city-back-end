...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20250930054406_UpdateAgora")]
    partial class UpdateAgora
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BusinessObject.Models.Account", b =>
                {
                    ...
                    b.Property<int>("RemainingVirtualEscorts")
                        .HasColumnType("integer")
                        .HasColumnName("remaining_virtual_escorts");
            ...
            modelBuilder.Entity("BusinessObject.Models.EscortJourneyWatcher", b =>
                {
                    ...
                    b.Property<string>("AgoraUid")
                        .HasColumnType("text")
                        .HasColumnName("agora_uid");

                    b.Property<string>("CallSessionName")
                        .HasColumnType("text")
                        .HasColumnName("call_session_name");
            ...
            modelBuilder.Entity("BusinessObject.Models.SosAlert", b =>
                {
                    ...
                    b.Property<string>("CallChannelName")
                        .HasColumnType("text")
                        .HasColumnName("call_channel_name");
            ...
            modelBuilder.Entity("BusinessObject.Models.EscortJourney", b =>
                {
                    ...
                    b.HasOne("BusinessObject.Models.EscortJourneyGroupMember", "Member")
            ...
            modelBuilder.Entity("BusinessObject.Models.EscortJourneyWatcher", b =>
                {
                    ...
                    b.HasOne("BusinessObject.Models.EscortJourneyGroupMember", "Watcher")
